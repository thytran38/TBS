...
//            properties.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");
            ...
            consumer.subscribe(Collections.singleton("trip-events"));  // replace you topic name
            ...
            for (ConsumerRecord<String, String> record : records) {
                ...
                System.out.printf(String.format("This record: %d has %s and %s%n", record.offset(), record.key(), record.value()));
                try {
