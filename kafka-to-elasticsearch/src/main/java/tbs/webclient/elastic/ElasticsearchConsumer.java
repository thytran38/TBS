...
//        String hostname = "localhost"; // localhost or bonsai url
...
//                });
    ...
    public static KafkaConsumer<String, String> createConsumer(String topic){
        ...
        String groupID = "elastic-group-06";
    ...
    public static void runTask() throws IOException {
        ...
        KafkaConsumer<String, String> consumer = createConsumer("trips2");
        final int giveUp = 100;
        int noRecordsCount = 0;

        consumer.subscribe(Collections.singleton("trips2"));
        ...
        while(true){
            ...
            for (ConsumerRecord<String, String> record : consumerRecords){
                ...
                try {
                    ...
                    IndexRequest indexRequest = new IndexRequest("prices").id(record.key())
